...
class ResendTransport implements EmailTransport {
  ...
  async send(msg: EmailMessage): Promise<void> {
    ...
    // killed ALL Arabic-locale emails (BUG-001). Encoding the JSON as a UTF-8
    // Buffer makes undici treat it as opaque bytes and send the real Unicode
    // payload; Resend accepts JSON as UTF-8.
