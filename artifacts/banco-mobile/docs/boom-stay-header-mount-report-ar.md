...
**الفرع:** `cursor/discover-enter-fix-4322` (يشمل ضغط الهيدر بعد PR #23)  
**التاريخ:** 2026-07-19  
...
| هوية ضخمة تأخذ نصف الشاشة | صف واحد: رجوع · B-OOM STAY + tagline · حفظ |
| بحث frosted داخل الوردي | حبة سوداء بإطار قرمزي ارتفاع 44 + فلتر على اليمين |
| chips نصية تحت الهيدر | تبويبات أيقونة+نص مضغوطة: All · Studio · Apartment · Villa · Chalet |
